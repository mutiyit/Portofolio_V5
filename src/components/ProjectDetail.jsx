...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/AhmadMutiMuhyiddin.com",
      };
  ...
  const projectUrl = `https://AhmadMutiMuhyiddin.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Ahmad Muti Muhyiddin </title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Ahmad Muti Muhyiddin  — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Ahmad Muti Muhyiddin `}
        />
        <meta
